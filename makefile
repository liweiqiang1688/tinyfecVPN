...
NATIVE_CXXFLAGS ?= -O3 -march=native

SOURCES=`find UDPspeeder -maxdepth 1 -name '*.cpp' ! -name main.cpp ! -name tunnel.cpp; find UDPspeeder/lib -maxdepth 1 -name '*.cpp'` main.cpp tun_dev.cpp tun_dev_client.cpp tun_dev_server.cpp
...
all:git_version
	rm -f ${NAME}
	${cc_local}   -o ${NAME}      ${INCLUDE}  ${SOURCES} ${FLAGS} -lrt -ggdb -static ${NATIVE_CXXFLAGS}
